...
import properties_ios_app_data_streams_update
...
def test_properties_ios_app_data_streams_update():
    ...
    with pytest.raises(Exception, match="403 The caller does not have permission"):
        properties_ios_app_data_streams_update.update_ios_app_data_stream(
