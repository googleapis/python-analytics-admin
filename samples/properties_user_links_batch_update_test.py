...
import properties_user_links_batch_update
...
def test_properties_user_links_batch_update():
    ...
    with pytest.raises(Exception, match="403 The caller does not have permission"):
        properties_user_links_batch_update.batch_update_property_user_link(
