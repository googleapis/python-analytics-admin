...
import properties_web_data_streams_update_enhanced_measurement_settings
...
def test_properties_web_data_streams_update():
    ...
    with pytest.raises(Exception, match="403 The caller does not have permission"):
        properties_web_data_streams_update_enhanced_measurement_settings.update_enhanced_measurement_settings(
