...
protocol secret for the iOS app data stream.

See https://developers.google.com/analytics/devguides/config/admin/v1/rest/v1alpha/properties.iosAppDataStreams.measurementProtocolSecrets/patch
for more information.
"""
# [START analyticsadmin_properties_ios_app_data_streams_measurement_protocol_secrets_update]
...
def update_measurement_protocol_secret(property_id, stream_id, secret_id):
    ...
    measurement_protocol_secret = client.update_measurement_protocol_secret(
        ios_app_data_stream=MeasurementProtocolSecret(
            name=f"properties/{property_id}/iosAppDataStreams/{stream_id}/measurementProtocolSecrets/{secret_id}",
...
# [END analyticsadmin_properties_ios_app_data_streams_measurement_protocol_secrets_update]
