...
class TestAnalyticsAdminServiceClient(object):
    ...
    def test_list_accounts(self):
        ...
        expected_response = analytics_admin_pb2.ListAccountsResponse(
            **expected_response
        )
    ...
    def test_provision_account_ticket(self):
        ...
        expected_response = analytics_admin_pb2.ProvisionAccountTicketResponse(
            **expected_response
        )
    ...
    def test_list_account_summaries(self):
        ...
        expected_response = analytics_admin_pb2.ListAccountSummariesResponse(
            **expected_response
        )
    ...
    def test_list_properties(self):
        ...
        expected_response = analytics_admin_pb2.ListPropertiesResponse(
            **expected_response
        )
    ...
    def test_batch_get_user_links(self):
        # Setup Expected Response
        expected_response = {}
        expected_response = analytics_admin_pb2.BatchGetUserLinksResponse(
            **expected_response
        )
        ...
        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.BatchGetUserLinksRequest(
    ...
    def test_list_user_links(self):
        ...
        expected_response = analytics_admin_pb2.ListUserLinksResponse(
            **expected_response
        )
    ...
    def test_audit_user_links(self):
        ...
        expected_response = analytics_admin_pb2.AuditUserLinksResponse(
            **expected_response
        )
    ...
    def test_create_user_link(self):
        ...
        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.CreateUserLinkRequest(
            parent=parent, user_link=user_link
        )
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_batch_create_user_links(self):
        # Setup Expected Response
        expected_response = {}
        expected_response = analytics_admin_pb2.BatchCreateUserLinksResponse(
            **expected_response
        )
        ...
        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.BatchCreateUserLinksRequest(
    ...
    def test_update_user_link(self):
        ...
        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.UpdateUserLinkRequest(
            user_link=user_link
        )
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_batch_update_user_links(self):
        # Setup Expected Response
        expected_response = {}
        expected_response = analytics_admin_pb2.BatchUpdateUserLinksResponse(
            **expected_response
        )
        ...
        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.BatchUpdateUserLinksRequest(
            parent=parent, requests=requests
        )
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_batch_delete_user_links(self):
        ...
        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.BatchDeleteUserLinksRequest(
            parent=parent, requests=requests
        )
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_update_web_data_stream(self):
        ...
        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.UpdateWebDataStreamRequest(
    ...
    def test_create_web_data_stream(self):
        ...
        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.CreateWebDataStreamRequest(
    ...
    def test_list_web_data_streams(self):
        ...
        expected_response = {
            "next_page_token": next_page_token,
            "web_data_streams": web_data_streams,
        }
        expected_response = analytics_admin_pb2.ListWebDataStreamsResponse(
            **expected_response
        )
    ...
    def test_update_ios_app_data_stream(self):
        ...
        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.UpdateIosAppDataStreamRequest(
    ...
    def test_create_ios_app_data_stream(self):
        ...
        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.CreateIosAppDataStreamRequest(
    ...
    def test_list_ios_app_data_streams(self):
        ...
        expected_response = {
            "next_page_token": next_page_token,
            "ios_app_data_streams": ios_app_data_streams,
        }
        expected_response = analytics_admin_pb2.ListIosAppDataStreamsResponse(
            **expected_response
        )
        ...
        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.ListIosAppDataStreamsRequest(
            parent=parent
        )
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_get_android_app_data_stream(self):
        ...
        # Setup Request
        name = client.android_app_data_stream_path(
    ...
    def test_delete_android_app_data_stream(self):
        ...
        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.DeleteAndroidAppDataStreamRequest(
            name=name
        )
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_update_android_app_data_stream(self):
        ...
        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.UpdateAndroidAppDataStreamRequest(
    ...
    def test_create_android_app_data_stream(self):
        ...
        response = client.create_android_app_data_stream(
            android_app_data_stream, parent
        )
        assert expected_response == response

        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.CreateAndroidAppDataStreamRequest(
    ...
    def test_list_android_app_data_streams(self):
        ...
        expected_response = {
            "next_page_token": next_page_token,
            "android_app_data_streams": android_app_data_streams,
        }
        expected_response = analytics_admin_pb2.ListAndroidAppDataStreamsResponse(
            **expected_response
        )
        ...
        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.ListAndroidAppDataStreamsRequest(
            parent=parent
        )
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_get_enhanced_measurement_settings(self):
        ...
        expected_response = {
            ...
            "content_views_enabled": content_views_enabled,
            "site_search_enabled": site_search_enabled,
            "form_interactions_enabled": form_interactions_enabled,
            "video_engagement_enabled": video_engagement_enabled,
            "file_downloads_enabled": file_downloads_enabled,
            "data_tagged_element_clicks_enabled": data_tagged_element_clicks_enabled,
            "page_loads_enabled": page_loads_enabled,
            "page_changes_enabled": page_changes_enabled,
            "articles_and_blogs_enabled": articles_and_blogs_enabled,
            "products_and_ecommerce_enabled": products_and_ecommerce_enabled,
            "search_query_parameter": search_query_parameter,
            "url_query_parameter": url_query_parameter,
            "excluded_domains": excluded_domains,
        }
        expected_response = resources_pb2.EnhancedMeasurementSettings(
            **expected_response
        )
        ...
        # Setup Request
        name = client.enhanced_measurement_settings_path(
        ...
        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.GetEnhancedMeasurementSettingsRequest(
            name=name
        )
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_update_enhanced_measurement_settings(self):
        ...
        response = client.update_enhanced_measurement_settings(
            enhanced_measurement_settings
        )
        assert expected_response == response

        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.UpdateEnhancedMeasurementSettingsRequest(
    ...
    def test_create_firebase_link(self):
        ...
        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.CreateFirebaseLinkRequest(
    ...
    def test_update_firebase_link(self):
        ...
        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.UpdateFirebaseLinkRequest(
    ...
    def test_list_firebase_links(self):
        # Setup Expected Response
        expected_response = {}
        expected_response = analytics_admin_pb2.ListFirebaseLinksResponse(
            **expected_response
        )
    ...
    def test_create_google_ads_link(self):
        ...
        assert len(channel.requests) == 1
        expected_request = analytics_admin_pb2.CreateGoogleAdsLinkRequest(
    ...
    def test_list_google_ads_links(self):
        ...
        expected_response = analytics_admin_pb2.ListGoogleAdsLinksResponse(
            **expected_response
        )
