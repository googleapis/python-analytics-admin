...
class AnalyticsAdminServiceClient(metaclass=AnalyticsAdminServiceClientMeta):
    ...
    @staticmethod
    def sk_ad_network_conversion_value_schema_path(property: str,data_stream: str,skadnetwork_conversion_value_schema: str,) -> str:
        """Returns a fully-qualified sk_ad_network_conversion_value_schema string."""
        return "properties/{property}/dataStreams/{data_stream}/sKAdNetworkConversionValueSchema/{skadnetwork_conversion_value_schema}".format(property=property, data_stream=data_stream, skadnetwork_conversion_value_schema=skadnetwork_conversion_value_schema, )
    ...
    def parse_sk_ad_network_conversion_value_schema_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^properties/(?P<property>.+?)/dataStreams/(?P<data_stream>.+?)/sKAdNetworkConversionValueSchema/(?P<skadnetwork_conversion_value_schema>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def get_sk_ad_network_conversion_value_schema(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_sk_ad_network_conversion_value_schema]
    ...
    def create_sk_ad_network_conversion_value_schema(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a analytics_admin.CreateSKAdNetworkConversionValueSchemaRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_sk_ad_network_conversion_value_schema]
    ...
    def delete_sk_ad_network_conversion_value_schema(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_sk_ad_network_conversion_value_schema]
    ...
    def update_sk_ad_network_conversion_value_schema(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a analytics_admin.UpdateSKAdNetworkConversionValueSchemaRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_sk_ad_network_conversion_value_schema]
    ...
    def list_sk_ad_network_conversion_value_schemas(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a analytics_admin.ListSKAdNetworkConversionValueSchemasRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_sk_ad_network_conversion_value_schemas]
