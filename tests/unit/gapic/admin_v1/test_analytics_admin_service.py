...
from google.analytics.admin_v1.services.analytics_admin_service import (
    AnalyticsAdminServiceAsyncClient,
)
from google.analytics.admin_v1.services.analytics_admin_service import (
    AnalyticsAdminServiceClient,
)
from google.analytics.admin_v1.services.analytics_admin_service import pagers
from google.analytics.admin_v1.services.analytics_admin_service import transports
from google.analytics.admin_v1.types import analytics_admin
from google.analytics.admin_v1.types import resources
...
def test_analytics_admin_service_client_client_options_from_dict():
    with mock.patch(
        "google.analytics.admin_v1.services.analytics_admin_service.transports.AnalyticsAdminServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_analytics_admin_service_transport_auth_adc():
    ...
    with mock.patch.object(auth, "default") as adc:
        adc.return_value = (credentials.AnonymousCredentials(), None)
        transports.AnalyticsAdminServiceGrpcTransport(host="squid.clam.whelk")
        adc.assert_called_once_with(
            scopes=(
                "https://www.googleapis.com/auth/analytics.edit",
                "https://www.googleapis.com/auth/analytics.manage.users",
