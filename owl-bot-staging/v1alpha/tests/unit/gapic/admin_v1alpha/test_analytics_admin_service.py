...
def test_analytics_admin_service_client_from_service_account_info(client_class, transport_name):
...
def test_analytics_admin_service_client_service_account_always_use_jwt(transport_class, transport_name):
...
def test_analytics_admin_service_client_from_service_account_file(client_class, transport_name):
    creds = ga_credentials.AnonymousCredentials()
...
@pytest.mark.parametrize("client_class", [
    AnalyticsAdminServiceClient, AnalyticsAdminServiceAsyncClient
])
@mock.patch.object(AnalyticsAdminServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AnalyticsAdminServiceClient))
@mock.patch.object(AnalyticsAdminServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AnalyticsAdminServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (AnalyticsAdminServiceClient, transports.AnalyticsAdminServiceGrpcTransport, "grpc", grpc_helpers),
    (AnalyticsAdminServiceAsyncClient, transports.AnalyticsAdminServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
])
def test_analytics_admin_service_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_analytics_admin_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
async def test_list_accounts_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_accounts(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
async def test_list_account_summaries_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_account_summaries(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
async def test_list_properties_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_properties(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
async def test_list_user_links_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_user_links(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
async def test_audit_user_links_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.audit_user_links(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_create_user_link_flattened():
    ...
    with mock.patch.object(
        ...
        mock_val = 'parent_value'
        assert arg == mock_val
        arg = args[0].user_link
        mock_val = resources.UserLink(name='name_value')
        assert arg == mock_val
...
def test_update_user_link_field_headers():
    ...
    request.user_link.name = 'name_value'
...
async def test_list_firebase_links_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_firebase_links(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
async def test_list_google_ads_links_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_google_ads_links(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_measurement_protocol_secret(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_measurement_protocol_secret),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_measurement_protocol_secret_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetMeasurementProtocolSecretRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_measurement_protocol_secrets_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ListMeasurementProtocolSecretsRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_admin.ListMeasurementProtocolSecretsResponse(
            next_page_token='next_page_token_value',
        ))
...
async def test_list_measurement_protocol_secrets_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_measurement_protocol_secrets(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_create_measurement_protocol_secret(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_measurement_protocol_secret),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.MeasurementProtocolSecret(
            name='name_value',
...
@pytest.mark.asyncio
async def test_create_measurement_protocol_secret_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.CreateMeasurementProtocolSecretRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_measurement_protocol_secret_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_measurement_protocol_secret(
            parent='parent_value',
            measurement_protocol_secret=resources.MeasurementProtocolSecret(name='name_value'),
        )
...
def test_delete_measurement_protocol_secret(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_measurement_protocol_secret),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_delete_measurement_protocol_secret_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.DeleteMeasurementProtocolSecretRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_measurement_protocol_secret(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_measurement_protocol_secret),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.MeasurementProtocolSecret(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_measurement_protocol_secret_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.UpdateMeasurementProtocolSecretRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_acknowledge_user_data_collection(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.acknowledge_user_data_collection),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_acknowledge_user_data_collection_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.AcknowledgeUserDataCollectionRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
async def test_search_change_history_events_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.search_change_history_events(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_google_signals_settings(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_google_signals_settings),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.consent == resources.GoogleSignalsConsent.GOOGLE_SIGNALS_CONSENT_CONSENTED
...
@pytest.mark.asyncio
async def test_get_google_signals_settings_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetGoogleSignalsSettingsRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resources.GoogleSignalsSettings(
            name='name_value',
            state=resources.GoogleSignalsState.GOOGLE_SIGNALS_ENABLED,
            consent=resources.GoogleSignalsConsent.GOOGLE_SIGNALS_CONSENT_CONSENTED,
        ))
...
def test_update_google_signals_settings(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_google_signals_settings),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.GoogleSignalsSettings(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_google_signals_settings_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.UpdateGoogleSignalsSettingsRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_conversion_event(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_conversion_event),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_create_conversion_event_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.CreateConversionEventRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resources.ConversionEvent(
            name='name_value',
            event_name='event_name_value',
            deletable=True,
            custom=True,
...
def test_get_conversion_event(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_conversion_event),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.ConversionEvent(
            name='name_value',
...
@pytest.mark.asyncio
async def test_get_conversion_event_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetConversionEventRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_conversion_event(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_conversion_event),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_delete_conversion_event_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.DeleteConversionEventRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_conversion_events_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ListConversionEventsRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_conversion_events_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.ConversionEvent)
                   for i in results)
...
async def test_list_conversion_events_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_conversion_events(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_display_video360_advertiser_link(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_display_video360_advertiser_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_display_video360_advertiser_link_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetDisplayVideo360AdvertiserLinkRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resources.DisplayVideo360AdvertiserLink(
            name='name_value',
            advertiser_id='advertiser_id_value',
            advertiser_display_name='advertiser_display_name_value',
        ))
...
@pytest.mark.asyncio
async def test_list_display_video360_advertiser_links_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ListDisplayVideo360AdvertiserLinksRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_admin.ListDisplayVideo360AdvertiserLinksResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_display_video360_advertiser_links_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.DisplayVideo360AdvertiserLink)
                   for i in results)
...
async def test_list_display_video360_advertiser_links_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_display_video360_advertiser_links(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_create_display_video360_advertiser_link(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_display_video360_advertiser_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.DisplayVideo360AdvertiserLink(
            name='name_value',
...
@pytest.mark.asyncio
async def test_create_display_video360_advertiser_link_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.CreateDisplayVideo360AdvertiserLinkRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_display_video360_advertiser_link(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_display_video360_advertiser_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_delete_display_video360_advertiser_link_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.DeleteDisplayVideo360AdvertiserLinkRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_display_video360_advertiser_link(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_display_video360_advertiser_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.DisplayVideo360AdvertiserLink(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_display_video360_advertiser_link_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.UpdateDisplayVideo360AdvertiserLinkRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_display_video360_advertiser_link_proposal(request_type, transport: str = 'grpc'):
    client = AnalyticsAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_display_video360_advertiser_link_proposal),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        assert args[0] == analytics_admin.GetDisplayVideo360AdvertiserLinkProposalRequest()
...
@pytest.mark.asyncio
async def test_get_display_video360_advertiser_link_proposal_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetDisplayVideo360AdvertiserLinkProposalRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resources.DisplayVideo360AdvertiserLinkProposal(
            name='name_value',
            advertiser_id='advertiser_id_value',
            advertiser_display_name='advertiser_display_name_value',
            validation_email='validation_email_value',
...
def test_list_display_video360_advertiser_link_proposals(request_type, transport: str = 'grpc'):
    client = AnalyticsAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        assert args[0] == analytics_admin.ListDisplayVideo360AdvertiserLinkProposalsRequest()
...
@pytest.mark.asyncio
async def test_list_display_video360_advertiser_link_proposals_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ListDisplayVideo360AdvertiserLinkProposalsRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_admin.ListDisplayVideo360AdvertiserLinkProposalsResponse(
            next_page_token='next_page_token_value',
        ))
    ...
    # Establish that the response is the type that we expect.
    assert isinstance(response, pagers.ListDisplayVideo360AdvertiserLinkProposalsAsyncPager)
    assert response.next_page_token == 'next_page_token_value'
...
def test_list_display_video360_advertiser_link_proposals_pager(transport_name: str = "grpc"):
    client = AnalyticsAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials,
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.DisplayVideo360AdvertiserLinkProposal)
                   for i in results)
def test_list_display_video360_advertiser_link_proposals_pages(transport_name: str = "grpc"):
    client = AnalyticsAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials,
        transport=transport_name,
    )
    ...
    with mock.patch.object(
        ...
        pages = list(client.list_display_video360_advertiser_link_proposals(request={}).pages)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
async def test_list_display_video360_advertiser_link_proposals_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_display_video360_advertiser_link_proposals(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
async def test_list_display_video360_advertiser_link_proposals_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_display_video360_advertiser_link_proposals(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_create_display_video360_advertiser_link_proposal(request_type, transport: str = 'grpc'):
    client = AnalyticsAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        assert args[0] == analytics_admin.CreateDisplayVideo360AdvertiserLinkProposalRequest()
...
@pytest.mark.asyncio
async def test_create_display_video360_advertiser_link_proposal_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.CreateDisplayVideo360AdvertiserLinkProposalRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        response = await client.create_display_video360_advertiser_link_proposal(request)
...
def test_create_display_video360_advertiser_link_proposal_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_display_video360_advertiser_link_proposal(
            parent='parent_value',
            display_video_360_advertiser_link_proposal=resources.DisplayVideo360AdvertiserLinkProposal(name='name_value'),
        )
...
def test_delete_display_video360_advertiser_link_proposal(request_type, transport: str = 'grpc'):
    client = AnalyticsAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        assert args[0] == analytics_admin.DeleteDisplayVideo360AdvertiserLinkProposalRequest()
...
@pytest.mark.asyncio
async def test_delete_display_video360_advertiser_link_proposal_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.DeleteDisplayVideo360AdvertiserLinkProposalRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        response = await client.delete_display_video360_advertiser_link_proposal(request)
...
def test_approve_display_video360_advertiser_link_proposal(request_type, transport: str = 'grpc'):
    client = AnalyticsAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        assert args[0] == analytics_admin.ApproveDisplayVideo360AdvertiserLinkProposalRequest()
...
@pytest.mark.asyncio
async def test_approve_display_video360_advertiser_link_proposal_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ApproveDisplayVideo360AdvertiserLinkProposalRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        response = await client.approve_display_video360_advertiser_link_proposal(request)
...
async def test_approve_display_video360_advertiser_link_proposal_async_from_dict():
    await test_approve_display_video360_advertiser_link_proposal_async(request_type=dict)
...
def test_cancel_display_video360_advertiser_link_proposal(request_type, transport: str = 'grpc'):
    client = AnalyticsAdminServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_cancel_display_video360_advertiser_link_proposal_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.CancelDisplayVideo360AdvertiserLinkProposalRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        response = await client.cancel_display_video360_advertiser_link_proposal(request)
...
def test_create_custom_dimension(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_custom_dimension),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_create_custom_dimension_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.CreateCustomDimensionRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resources.CustomDimension(
            name='name_value',
            parameter_name='parameter_name_value',
            display_name='display_name_value',
            description='description_value',
...
def test_update_custom_dimension(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_custom_dimension),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.CustomDimension(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_custom_dimension_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.UpdateCustomDimensionRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_custom_dimensions_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ListCustomDimensionsRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_admin.ListCustomDimensionsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_custom_dimensions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.CustomDimension)
                   for i in results)
...
async def test_list_custom_dimensions_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_custom_dimensions(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_archive_custom_dimension(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.archive_custom_dimension),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_archive_custom_dimension_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ArchiveCustomDimensionRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_custom_dimension(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_custom_dimension),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.CustomDimension(
            name='name_value',
...
@pytest.mark.asyncio
async def test_get_custom_dimension_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetCustomDimensionRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_custom_metric(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_custom_metric),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.CustomMetric(
            ...
            restricted_metric_type=[resources.CustomMetric.RestrictedMetricType.COST_DATA],
        )
    ...
    assert response.restricted_metric_type == [resources.CustomMetric.RestrictedMetricType.COST_DATA]
...
@pytest.mark.asyncio
async def test_create_custom_metric_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.CreateCustomMetricRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resources.CustomMetric(
            name='name_value',
            parameter_name='parameter_name_value',
            display_name='display_name_value',
            description='description_value',
...
def test_update_custom_metric(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_custom_metric),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.CustomMetric(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_custom_metric_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.UpdateCustomMetricRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_custom_metrics_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ListCustomMetricsRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_admin.ListCustomMetricsResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_custom_metrics_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.CustomMetric)
                   for i in results)
...
async def test_list_custom_metrics_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_custom_metrics(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_archive_custom_metric(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.archive_custom_metric),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_archive_custom_metric_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ArchiveCustomMetricRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_custom_metric(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_custom_metric),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.CustomMetric(
            name='name_value',
...
@pytest.mark.asyncio
async def test_get_custom_metric_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetCustomMetricRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_data_retention_settings(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_data_retention_settings),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.name == 'name_value'
    assert response.event_data_retention == resources.DataRetentionSettings.RetentionDuration.TWO_MONTHS
...
@pytest.mark.asyncio
async def test_get_data_retention_settings_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetDataRetentionSettingsRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resources.DataRetentionSettings(
            name='name_value',
            event_data_retention=resources.DataRetentionSettings.RetentionDuration.TWO_MONTHS,
            reset_user_data_on_new_activity=True,
        ))
...
def test_update_data_retention_settings(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_data_retention_settings),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.DataRetentionSettings(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_data_retention_settings_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.UpdateDataRetentionSettingsRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_data_stream(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_data_stream),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.DataStream(
            ...
            display_name='display_name_value',
            web_stream_data=resources.DataStream.WebStreamData(measurement_id='measurement_id_value'),
        )
...
@pytest.mark.asyncio
async def test_create_data_stream_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.CreateDataStreamRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(resources.DataStream(
            name='name_value',
            type_=resources.DataStream.DataStreamType.WEB_DATA_STREAM,
            display_name='display_name_value',
        ))
...
def test_create_data_stream_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_data_stream(
            parent='parent_value',
            data_stream=resources.DataStream(web_stream_data=resources.DataStream.WebStreamData(measurement_id='measurement_id_value')),
        )
        ...
        mock_val = resources.DataStream(web_stream_data=resources.DataStream.WebStreamData(measurement_id='measurement_id_value'))
        assert arg == mock_val
...
def test_delete_data_stream(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_data_stream),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_delete_data_stream_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.DeleteDataStreamRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_data_stream(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_data_stream),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.DataStream(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_data_stream_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.UpdateDataStreamRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_list_data_streams_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ListDataStreamsRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_data_streams_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, resources.DataStream)
                   for i in results)
...
async def test_list_data_streams_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_data_streams(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_data_stream(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_data_stream),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.DataStream(
            name='name_value',
...
@pytest.mark.asyncio
async def test_get_data_stream_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetDataStreamRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_audience(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_audience),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.exclusion_duration_mode == audience.Audience.AudienceExclusionDurationMode.EXCLUDE_TEMPORARILY
...
@pytest.mark.asyncio
async def test_get_audience_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetAudienceRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_audiences(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_audiences),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_list_audiences_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ListAudiencesRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_admin.ListAudiencesResponse(
            next_page_token='next_page_token_value',
        ))
...
def test_list_audiences_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, audience.Audience)
                   for i in results)
...
async def test_list_audiences_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_audiences(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
async def test_list_audiences_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_audiences(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_create_audience(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_audience),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.membership_duration_days == 2561
    assert response.ads_personalization_enabled is True
    assert response.exclusion_duration_mode == gaa_audience.Audience.AudienceExclusionDurationMode.EXCLUDE_TEMPORARILY
...
@pytest.mark.asyncio
async def test_create_audience_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.CreateAudienceRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(gaa_audience.Audience(
            name='name_value',
            display_name='display_name_value',
            description='description_value',
            membership_duration_days=2561,
...
def test_update_audience(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_audience),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = gaa_audience.Audience(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_audience_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.UpdateAudienceRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_archive_audience(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.archive_audience),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
@pytest.mark.asyncio
async def test_archive_audience_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.ArchiveAudienceRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_attribution_settings(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_attribution_settings),
            '__call__') as call:
        # Designate an appropriate return value for the call.
    ...
    assert response.name == 'name_value'
    assert response.acquisition_conversion_event_lookback_window == resources.AttributionSettings.AcquisitionConversionEventLookbackWindow.ACQUISITION_CONVERSION_EVENT_LOOKBACK_WINDOW_7_DAYS
    assert response.other_conversion_event_lookback_window == resources.AttributionSettings.OtherConversionEventLookbackWindow.OTHER_CONVERSION_EVENT_LOOKBACK_WINDOW_30_DAYS
    assert response.reporting_attribution_model == resources.AttributionSettings.ReportingAttributionModel.CROSS_CHANNEL_DATA_DRIVEN
...
@pytest.mark.asyncio
async def test_get_attribution_settings_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.GetAttributionSettingsRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_attribution_settings(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_attribution_settings),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = resources.AttributionSettings(
            name='name_value',
...
@pytest.mark.asyncio
async def test_update_attribution_settings_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.UpdateAttributionSettingsRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_run_access_report(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.run_access_report),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_run_access_report_async(transport: str = 'grpc_asyncio', request_type=analytics_admin.RunAccessReportRequest):
    client = AnalyticsAdminServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(analytics_admin.RunAccessReportResponse(
            row_count=992,
        ))
...
def test_attribution_settings_path():
    property = "oyster"
    expected = "properties/{property}/attributionSettings".format(property=property, )
...
def test_audience_path():
    property = "cuttlefish"
    audience = "mussel"
    expected = "properties/{property}/audiences/{audience}".format(property=property, audience=audience, )
...
def test_conversion_event_path():
    ...
    expected = "properties/{property}/conversionEvents/{conversion_event}".format(property=property, conversion_event=conversion_event, )
    actual = AnalyticsAdminServiceClient.conversion_event_path(property, conversion_event)
    assert expected == actual
...
def test_custom_dimension_path():
    ...
    expected = "properties/{property}/customDimensions/{custom_dimension}".format(property=property, custom_dimension=custom_dimension, )
    actual = AnalyticsAdminServiceClient.custom_dimension_path(property, custom_dimension)
    assert expected == actual
...
def test_custom_metric_path():
    ...
    expected = "properties/{property}/customMetrics/{custom_metric}".format(property=property, custom_metric=custom_metric, )
...
def test_data_stream_path():
    property = "whelk"
    data_stream = "octopus"
    expected = "properties/{property}/dataStreams/{data_stream}".format(property=property, data_stream=data_stream, )
...
def test_display_video360_advertiser_link_path():
    ...
    expected = "properties/{property}/displayVideo360AdvertiserLinks/{display_video_360_advertiser_link}".format(property=property, display_video_360_advertiser_link=display_video_360_advertiser_link, )
    actual = AnalyticsAdminServiceClient.display_video360_advertiser_link_path(property, display_video_360_advertiser_link)
    assert expected == actual
...
def test_parse_display_video360_advertiser_link_path():
    ...
    # Check that the path construction is reversible.
    actual = AnalyticsAdminServiceClient.parse_display_video360_advertiser_link_path(path)
    assert expected == actual

def test_display_video360_advertiser_link_proposal_path():
    property = "scallop"
    display_video_360_advertiser_link_proposal = "abalone"
    expected = "properties/{property}/displayVideo360AdvertiserLinkProposals/{display_video_360_advertiser_link_proposal}".format(property=property, display_video_360_advertiser_link_proposal=display_video_360_advertiser_link_proposal, )
    actual = AnalyticsAdminServiceClient.display_video360_advertiser_link_proposal_path(property, display_video_360_advertiser_link_proposal)
    assert expected == actual
...
def test_parse_display_video360_advertiser_link_proposal_path():
    ...
    path = AnalyticsAdminServiceClient.display_video360_advertiser_link_proposal_path(**expected)

    # Check that the path construction is reversible.
    actual = AnalyticsAdminServiceClient.parse_display_video360_advertiser_link_proposal_path(path)
    assert expected == actual
...
def test_global_site_tag_path():
    property = "cuttlefish"
    data_stream = "mussel"
    expected = "properties/{property}/dataStreams/{data_stream}/globalSiteTag".format(property=property, data_stream=data_stream, )
...
def test_measurement_protocol_secret_path():
    ...
    expected = "properties/{property}/dataStreams/{data_stream}/measurementProtocolSecrets/{measurement_protocol_secret}".format(property=property, data_stream=data_stream, measurement_protocol_secret=measurement_protocol_secret, )
    actual = AnalyticsAdminServiceClient.measurement_protocol_secret_path(property, data_stream, measurement_protocol_secret)
    assert expected == actual
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (AnalyticsAdminServiceAsyncClient, transports.AnalyticsAdminServiceGrpcAsyncIOTransport),
])
