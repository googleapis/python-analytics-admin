...
class AnalyticsAdminServiceGrpcAsyncIOTransport(AnalyticsAdminServiceTransport):
    ...
    def create_data_stream(self) -> Callable[
            ...
            Awaitable[resources.DataStream]]:
    ...
    def create_audience(self) -> Callable[
            ...
            Awaitable[gaa_audience.Audience]]:
    ...
    def create_access_binding(self) -> Callable[
            ...
            Awaitable[resources.AccessBinding]]:
    ...
    def get_channel_group(self) -> Callable[
            ...
            Awaitable[channel_group.ChannelGroup]]:
    ...
    def get_ad_sense_link(self) -> Callable[
            ...
            Awaitable[resources.AdSenseLink]]:
