...
from google.analytics.admin_v1beta.services.analytics_admin_service import AnalyticsAdminServiceAsyncClient
from google.analytics.admin_v1beta.services.analytics_admin_service import AnalyticsAdminServiceClient
from google.analytics.admin_v1beta.services.analytics_admin_service import pagers
from google.analytics.admin_v1beta.services.analytics_admin_service import transports
...
def test_analytics_admin_service_client_client_options_from_dict():
    with mock.patch('google.analytics.admin_v1beta.services.analytics_admin_service.transports.AnalyticsAdminServiceGrpcTransport.__init__') as grpc_transport:
...
def test_analytics_admin_service_base_transport():
    ...
    with mock.patch('google.analytics.admin_v1beta.services.analytics_admin_service.transports.AnalyticsAdminServiceTransport.__init__') as Transport:
...
def test_analytics_admin_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.analytics.admin_v1beta.services.analytics_admin_service.transports.AnalyticsAdminServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_analytics_admin_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.analytics.admin_v1beta.services.analytics_admin_service.transports.AnalyticsAdminServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.AnalyticsAdminServiceTransport()
        adc.assert_called_once()
...
def test_analytics_admin_service_transport_auth_adc(transport_class):
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        ...
        adc.assert_called_once_with(
            scopes=["1", "2"],
            default_scopes=(                'https://www.googleapis.com/auth/analytics.edit',                'https://www.googleapis.com/auth/analytics.readonly',),
            quota_project_id="octopus",
        )
