...
import properties_ios_app_data_streams_delete
...
def test_properties_ios_app_data_streams_delete():
    ...
    with pytest.raises(Exception, match="403 The caller does not have permission"):
        properties_ios_app_data_streams_delete.delete_ios_app_data_stream(
